 ...
 */
public class RepositorioNota implements InterfaceRepositorio.Interface{
    ...
    public Object recuperar(int id) {
        return DaoManagerHiber.recover("from Nota where id ="+ id).get(0);
    }
    ...
    public List recuperarTodos() {
        return DaoManagerHiber.recover("from Nota");
    }
